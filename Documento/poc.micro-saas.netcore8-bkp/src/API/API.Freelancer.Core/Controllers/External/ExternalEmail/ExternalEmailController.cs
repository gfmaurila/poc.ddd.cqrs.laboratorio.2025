namespace API.Freelancer.Core.Controllers.External.ExternalEmail;
using API.Freelancer.Core.Controllers;

using API.Freelancer.Core.Feature.External.ExternalEmail.Create;
using API.Freelancer.Core.Feature.External.ExternalEmail.Create.Model;
