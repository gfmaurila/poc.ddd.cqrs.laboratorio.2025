...
using API.InventoryControl.Core.Infrastructure.Auth;
using API.InventoryControl.Core.Infrastructure.Database;
using API.InventoryControl.Core.Infrastructure.Database.Repositories;
using API.InventoryControl.Core.Infrastructure.Database.Repositories.Interfaces;
using API.InventoryControl.Core.Infrastructure.Integration;
using API.InventoryControl.Core.Infrastructure.Redis;
using Microsoft.EntityFrameworkCore;
using System.Reflection;

namespace API.InventoryControl.Core.Extensions;
...
public static class InfrastructureExtensions
{
    ...
    public static async Task MigrateAsync(this WebApplication app)
    {
        ...
        await using var writeDbContext = serviceScope.ServiceProvider.GetRequiredService<InventoryControlAppDbContext>();
    ...
    public static void ApplyMigrations(this IHost app)
    {
        ...
        try
        {
            var context = services.GetRequiredService<InventoryControlAppDbContext>();
