namespace API.Customer.Core.Controllers.External.ExternalEmail;
using API.Customer.Core.Controllers;

using API.Customer.Core.Feature.External.ExternalEmail.Create;
using API.Customer.Core.Feature.External.ExternalEmail.Create.Model;
