namespace API.Clinic.Core.Controllers.External.ExternalEmail;
using API.Clinic.Core.Controllers;

using API.Clinic.Core.Feature.External.ExternalEmail.Create;
