using API.Clinic.Core.Feature.Notification.Messaging.Kafka.Subscribe;
using API.Clinic.Core.Feature.Notification.Messaging.RabbiMQ.Subscribe;
using API.Clinic.Core.Infrastructure.Messaging.RabbiMQ;
