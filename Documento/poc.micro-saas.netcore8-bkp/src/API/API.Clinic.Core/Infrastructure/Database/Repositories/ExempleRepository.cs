...
using API.Clinic.Core.Feature.Domain.Exemple.Models;
...
namespace API.Clinic.Core.Infrastructure.Database.Repositories;
...
public class ExempleRepository : BaseRepository<ExempleEntity>, IExempleRepository
{
    ...
    public ExempleRepository(ClinicAppDbContext context) : base(context)
    {
        _context = context;
    }
