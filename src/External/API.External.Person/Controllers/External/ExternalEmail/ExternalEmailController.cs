namespace API.External.Person.Controllers.External.ExternalEmail;
using API.External.Person.Controllers;

using API.External.Person.Feature.External.ExternalEmail.Create;
using API.External.Person.Feature.External.ExternalEmail.Create.Model;
