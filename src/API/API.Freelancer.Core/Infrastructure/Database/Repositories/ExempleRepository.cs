...
namespace API.Freelancer.Core.Infrastructure.Database.Repositories;
...
{
    private readonly FreelancerAppDbContext _context;
    ...
    public ExempleRepository(FreelancerAppDbContext context) : base(context)
    {
        _context = context;
    }
