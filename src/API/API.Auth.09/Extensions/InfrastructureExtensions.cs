...
//using API.Auth.Infrastructure.Database.Repositories;
//using API.Auth.Infrastructure.Database.Repositories.Interface;
//using API.Auth.Infrastructure.Messaging.Kafka.Publisher;
//using Common.Core.Infrastructure.Messaging.Kafka.Interface;
...
//        services.AddDbContext<ModeloAppDbContext>(options =>
