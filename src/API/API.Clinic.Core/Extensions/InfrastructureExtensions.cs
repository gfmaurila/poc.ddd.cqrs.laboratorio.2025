using API.Clinic.Core.Infrastructure.Auth;
using API.Clinic.Core.Infrastructure.Database;
using API.Clinic.Core.Infrastructure.Database.Repositories;
using API.Clinic.Core.Infrastructure.Database.Repositories.Interfaces;
using API.Clinic.Core.Infrastructure.Integration;
using API.Clinic.Core.Infrastructure.Redis;
using API.Exemple1.Core._08.Infrastructure.Messaging;
using Microsoft.EntityFrameworkCore;
using System.Reflection;

namespace API.Clinic.Core.Extensions;
...
public static class InfrastructureExtensions
{
    ...
    public static async Task MigrateAsync(this WebApplication app)
    {
        ...
        await using var writeDbContext = serviceScope.ServiceProvider.GetRequiredService<ClinicAppDbContext>();
