namespace API.InventoryControl.Core.Controllers.External.ExternalEmail;
using API.InventoryControl.Core.Controllers;

using API.InventoryControl.Core.Feature.External.ExternalEmail.Create;
using API.InventoryControl.Core.Feature.External.ExternalEmail.Create.Model;
