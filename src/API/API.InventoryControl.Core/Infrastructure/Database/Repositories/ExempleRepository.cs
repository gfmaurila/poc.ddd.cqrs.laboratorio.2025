...
using API.InventoryControl.Core.Feature.Domain.Exemple.Models;
...
namespace API.InventoryControl.Core.Infrastructure.Database.Repositories;
...
{
    private readonly InventoryControlAppDbContext _context;
    ...
    public ExempleRepository(InventoryControlAppDbContext context) : base(context)
    {
        _context = context;
    }
