using API.InventoryControl.Core.Infrastructure.Integration.ExternalEmail;
using API.InventoryControl.Core.Infrastructure.Integration.ExternalEmail.Api;
using API.InventoryControl.Core.Infrastructure.Integration.ExternalEmail.Service;
using Refit;

namespace API.InventoryControl.Core.Infrastructure.Integration;
