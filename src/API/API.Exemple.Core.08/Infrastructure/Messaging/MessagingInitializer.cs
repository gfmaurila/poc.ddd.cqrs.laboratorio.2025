...
using API.Exemple1.Core._08.Feature.Exemple.Commands.Create.Events.Messaging.Publish;
using API.Exemple1.Core._08.Feature.Exemple.Commands.Create.Events.Messaging.Subscribe;
using API.Exemple1.Core._08.Feature.Exemple.Commands.Delete.Events.Messaging.Publish;
