using API.Customer.Core.Feature.Exemple.Commands.Create.Events.Messaging;
using API.Customer.Core.Feature.Exemple.Commands.Delete.Events.Messaging;
using API.Customer.Core.Feature.Exemple.Commands.Delete.Events.Messaging.Subscribe;
using API.Customer.Core.Feature.Exemple.Commands.Update.Events.Messaging.RabbiMQ;
using API.Customer.Core.Feature.Exemple.Commands.Update.Events.Messaging.RabbiMQ.Subscribe;
using API.Customer.Core.Feature.Notification.Messaging.Kafka;
using API.Customer.Core.Feature.Notification.Messaging.Kafka.Subscribe;
using API.Customer.Core.Feature.Notification.Messaging.RabbiMQ;
using API.Customer.Core.Feature.Notification.Messaging.RabbiMQ.Subscribe;
using API.Customer.Core.Feature.Notification.Messaging.Service;
using API.Customer.Core.Infrastructure.Messaging.RabbiMQ;
using Common.Core._08.Interface;
using Common.Core._08.Kafka;
using Microsoft.Extensions.Options;

namespace API.Customer.Core.Infrastructure.Messaging;
