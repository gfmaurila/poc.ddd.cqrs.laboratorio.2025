using API.Customer.Core.Infrastructure.Database;
...
public class TestInMemoryWebApplicationFactory<TProgram> : WebApplicationFactory<TProgram> where TProgram : class
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            var descriptor = services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<CustomerAppDbContext>));
            ...
            using var appContext = scope.ServiceProvider.GetRequiredService<CustomerAppDbContext>();
